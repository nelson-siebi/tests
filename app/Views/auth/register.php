...
>
    ...
    <div class="max-w-md w-full relative z-10 py-12">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-500 dark:text-slate-400 mt-3 font-semibold text-sm"><?= __('register_title') ?></p>
        </div>
        ...
        <div class="bg-white/80 dark:bg-slate-900/60 backdrop-blur-md p-8 md:p-10 rounded-3xl shadow-xl border border-slate-200/50 dark:border-slate-800/80">
            <h1 class="text-2xl font-black mb-8 text-slate-900 dark:text-white"><?= __('create_account') ?></h1>
            ...
            <!-- Form -->
            <form action="/register" method="POST" class="space-y-5" x-data="{ loading: false, showPass: false }" @submit="loading = true">
                <!-- Full Name Field -->
                <div class="space-y-2">
            ...
            <div class="mt-8 text-center border-t border-slate-100 dark:border-slate-800 pt-8">
                <p class="text-slate-400 dark:text-slate-500 font-bold text-xs">
                    ...
                    <a href="/login" class="text-primary hover:text-primary-hover font-black ml-1">
                        <?= __('login_btn') ?>
                    </a>
                </p>
            </div>
